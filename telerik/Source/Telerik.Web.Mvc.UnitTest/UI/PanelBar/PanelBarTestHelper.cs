namespace Telerik.Web.Mvc.UI.UnitTest
{
    ...
    public static class PanelBarTestHelper
    {
        ...
        public static PanelBar CreatePanelbar(HtmlTextWriter writer, IPanelBarHtmlBuilder renderer)
        {
            ...
            Mock<IPanelBarHtmlBuilderFactory> panelBarRendererFactory = new Mock<IPanelBarHtmlBuilderFactory>();
