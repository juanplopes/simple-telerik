...
namespace Telerik.Web.Mvc.UI
{
    ...
    public class GridLocalizedStrings : LocalizedStrings
    {
        public GridLocalizedStrings() : this(null)
        {
        }

        public GridLocalizedStrings(CultureInfo culture) : this(null, culture)
        {
        }

        public GridLocalizedStrings(string resourceLocation, CultureInfo culture) : base(resourceLocation, "GridLocalization", culture)
        {
        }
