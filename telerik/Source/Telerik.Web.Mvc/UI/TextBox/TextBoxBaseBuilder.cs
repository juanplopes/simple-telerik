...
namespace Telerik.Web.Mvc.UI
{
    ...
    /// </summary>
    public class TextBoxBaseBuilder<T, TBuilder> : ViewComponentBuilderBase<TextBoxBase<T>, TBuilder>, IHideObjectMembers 
        where T : struct
        where TBuilder : TextBoxBaseBuilder<T, TBuilder>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextBoxBaseBuilder"/> class.
        /// </summary>
        /// <param name="component">The component.</param>
        public TextBoxBaseBuilder(TextBoxBase<T> component)
            : base(component)
        {
        }
        ...
        {
            Guard.IsNotNull(minValue, "minValue");
        ...
        {
            Guard.IsNotNull(maxValue, "maxValue");
