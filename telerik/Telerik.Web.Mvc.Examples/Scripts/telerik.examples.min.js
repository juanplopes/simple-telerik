$(function() {
    ...
    var availableSkins = [
		'Black', 'Default', 'Forest', 'Hay', 'Office2007', 'Outlook', 'Simple',
		'Sitefinity', 'Sunset', 'Telerik', 'Vista', 'Web20', 'WebBlue', 'Windows7'
	];
    ...
    function getThemeGalleryHtml() {
        ...
        themeGalleryHtml.cat('<div id="theme-gallery"><ul>');
...
function codeTabLoad() {
    var tabStrip = $('#code-viewer-tabs').data('tTabStrip');
